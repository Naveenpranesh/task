...
<head>
    ...
    <title>Make Your Food</title>
    <link rel="icon" href="<?php echo APPLICATION_URL.'resources/images/recipes.png' ?>" type="image/x-icon"
        style="display: inline-block; border-radius: 60px;  padding: 0.5em 0.6em;">
    ...
    <div class="container">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="<?php echo APPLICATION_URL.'resources/images/barbeque.svg'; ?>" class="image" alt="" />
            </div>
