...
global $library;
$fileLoaderObj = new fileLoader("admin");
$fileLoaderObj->addFile("application/admin/model/admin.class.inc",true);
$fileLoaderObj->addFile("application/admin/controller/admin.service.class.inc");
