...
global $library;
$fileLoaderObj = new fileLoader("ascbasics");
$fileLoaderObj->addFile("application/ascbasics/model/ascbasics.class.inc",true);
$fileLoaderObj->addFile("application/ascbasics/controller/ascbasics.service.class.inc");
